...
#此脚本已弃用，请使用： https://github.com/10935336/109Shell/blob/main/update_github_hosts.sh
#This script is deprecated, please use: https://github.com/10935336/109Shell/blob/main/update_github_hosts.sh
...
# 删除现有 hosts 暂存中多余的内容
sed -i '/# 地址可能会变动，请务必关注GitHub、Gitlab获取最新消息/,/# 也可以关注公众号：湖中剑，保证不迷路/d' hosts-temp
